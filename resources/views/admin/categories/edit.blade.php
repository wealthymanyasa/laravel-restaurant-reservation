        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category->id) }}"
                    ...
                    @csrf
                    <div class="">
                        <h2 class="text-xl font-bold text-green-700 uppercase text-center">Edit category</h2>
                    </div>
                    @method('PUT')
                    <div class="mb-6">
                        <label for="name"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="">
                            <img class="w-16 h-16 rounded-lg" src="{{ Storage::url($category->image) }}"
                                alt="category/img">
                        </div>
                        <input
                    ...
                    <div class="flex items-start mb-6">
                        <button type="submit"
                            class="text-white p-2 bg-indigo-500 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 @error('description') border-red-400 @enderror">
